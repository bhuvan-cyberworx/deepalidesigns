...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse " id="">
    <ul class="nav justify-content-end w-100">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#"><!-- <i class="fa fa-align-left"></i> --> About</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><!-- <i class="fas fa-th-large"></i> --> Portfolio</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><!-- <i class="fa fa-box-open"></i> --> Product</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><!-- <i class="fa fa-thumbs-up"></i> --> Clients</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><!-- <i class="fa fa-th"></i> --> Gallery</a>
      </li>
      <li class="nav-item">
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 text-center">
            <h3 class="float-left mb0 text-white">Looking for inspiration for your upcoming event?</h3>
            <a class="btn btn-lg callAction mb0" href="#" target="_self">Contact Us</a>
        </div>
    </div>
</section>
