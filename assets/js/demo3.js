            ...
            const animateSlides = () => {
                return new Promise((resolve, reject) => {
                    ...
                    anime({
                        ...
                        duration: this.settings.animation.slides.duration,
                        easing: this.settings.animation.slides.easing,
                        delay: (t,i,total) => dir === 'next' ? i*100+1050 : (total-i-1)*100+1050,
